...
#     # ---------------------------------------------------
    ...
    if style == "google":
        style_guidance = """
STRICTLY use Google docstring format.
...
"""
        ...
        style_guidance = """
STRICTLY use NumPy docstring format.
...
"""
        ...
        style_guidance = """
STRICTLY use reStructuredText (reST) format.
...
"""
    ...
    prompt = f"""
Generate ONLY a {style} style Python docstring.

{style_guidance}

STRICT RULES:
- Follow ONLY the specified style
- Do NOT mix styles
